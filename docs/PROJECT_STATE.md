...
| `P0-CONTRACT-01` | CLAIMED | Contract/Domain (`/root/p0_contract_01`) / same owner | `576a435` / working tree | `DATA-REVISION-001`、`SAFE-IPC-001`、`EXT-ROUTER-001`、`EXT-COMMAND-001` / IPC v1 + generated bindings | [`P0-CONTRACT-01.md`](tasks/P0-CONTRACT-01.md)；基线 validator 与安装冻结依赖后的 `pnpm verify` PASS，下一步从 03 canonical schema 生成 Rust/TS 契约 |
