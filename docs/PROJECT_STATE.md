...
| `P0-SPIKE-01` | CLAIMED | Editor review fixes (`/root/p0_spike_01_fix`) / Integration | `576a435` / `caed664` | `EDIT-IME-001`、`EDIT-TABLE-001`、`PERF-VIEWPORT-001` / second-review marker-safety correction | [`P0-SPIKE-01.md`](tasks/P0-SPIKE-01.md)；撤销未完成的 list/quote marker replacement，补光标与 composition 回归后重跑门禁 |
