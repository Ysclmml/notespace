...
| `P0-CONTRACT-01` | REVIEW | Contract/Domain (`/root/p0_contract_01`) / Integration (`/root`) | `576a435` / implementation `bfe1dd5` | `DATA-REVISION-001`、`SAFE-IPC-001`、`EXT-ROUTER-001`、`EXT-COMMAND-001` / IPC `1.0-draft` Rust schema + generated TypeScript + canonical manifest | [`P0-CONTRACT-01.md`](tasks/P0-CONTRACT-01.md)；`CONTRACT-001`–`003`、schema drift、validator、`pnpm verify` 与干净 clone 全部 PASS；`004`–`024` 仅冻结端口；Integration 下一步按 Phase 0 顺序集成并重跑三项门禁，F0 前保持 draft |
