...
| `P0-CONTRACT-01` | REVIEW | Contract/Domain (`/root/p0_contract_01`) / Integration + independent Contract reviewer | third-review base `91a2782` / implementation `af6302e` | `DATA-REVISION-001`、`SAFE-IPC-001`、`EXT-ROUTER-001`、`EXT-COMMAND-001` / IPC `1.0-draft` Rust-derived schema | [`P0-CONTRACT-01.md`](tasks/P0-CONTRACT-01.md)；五项生成物 drift、Rust/TS `CONTRACT-001`–`003`、字段/fixture mutation、空 error-code parity、`pnpm verify` 与最终 clean clone 全部 PASS；下一步由 Integration 独立复审并在 `P0-CI-01` 接入 runner，`004`–`024` 仍为 frozen ports |
