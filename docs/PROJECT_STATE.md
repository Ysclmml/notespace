...
| `P0-CONTRACT-01` | REVIEW | Contract/Domain (`/root/p0_contract_01`) / Integration | original `576a435`; rework `0387139` / implementation `42563ee` | `DATA-REVISION-001`、`SAFE-IPC-001`、`EXT-ROUTER-001`、`EXT-COMMAND-001` / IPC `1.0-draft` Rust-derived schema | [`P0-CONTRACT-01.md`](tasks/P0-CONTRACT-01.md)；手写 TS 双源已删除，44 组 concrete serde fixtures 与严格 fail-closed regression 落地；contract runner、mutation drift、`pnpm verify`、clean clone PASS；下一步 Integration 独立审查并决定 F0 发布，`004`–`024` 仍为 frozen ports |
