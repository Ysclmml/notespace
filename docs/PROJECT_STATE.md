...
| `P0-FIXTURE-01` | CLAIMED | QA / `/root` | `28e6d8e` / working tree | `DATA-ROUNDTRIP-001`、`DATA-UNKNOWN-001`、`EDIT-IME-001`、`EDIT-TABLE-001` / privacy-safe fixtures | [`P0-FIXTURE-01.md`](tasks/P0-FIXTURE-01.md)；添加 versioned synthetic corpus 与 runtime-only pathological generator |
