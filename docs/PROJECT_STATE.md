...
| `P0-CONTRACT-01` | CLAIMED | Contract/Domain (`/root/p0_contract_01`) / same owner | original `576a435`; rework `0387139` / working tree | `DATA-REVISION-001`、`SAFE-IPC-001`、`EXT-ROUTER-001`、`EXT-COMMAND-001` / IPC `1.0-draft` Rust-derived schema rework | [`P0-CONTRACT-01.md`](tasks/P0-CONTRACT-01.md)；独立审查 NO-MERGE，旧 PASS 证据已撤销；下一步删除手写 TS 双源、补全 Rust serde surface/真实 fixtures 与 fail-closed regression，`004`–`024` 保持 frozen |
