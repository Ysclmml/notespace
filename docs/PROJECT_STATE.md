...
| `P0-SPIKE-01` | REVIEW | Editor (`/root/p0_spike_01`) / Integration | `576a435` / `25ce6e4` | `EDIT-IME-001`、`EDIT-TABLE-001`、`PERF-LARGE-001` / isolated CodeMirror feasibility + 30-sample measurements | [`P0-SPIKE-01.md`](tasks/P0-SPIKE-01.md)；9 个 focused tests、12 个全量前端 tests、measurement、`pnpm verify` 与文档门禁 PASS；Integration 复核依赖与局限后合并并跑 schema drift |
