...
| `P0-HOST-SMOKE-01` | CLAIMED | `/root/p0_host_smoke` / Integration | `4fcc284` / `263d750` | `EDIT-IME-001`、`FILE-SAVE-001`、`UX-KEY-001`、`UX-PLATFORM-001` / macOS release-host evidence only | [`P0-HOST-SMOKE-01.md`](tasks/P0-HOST-SMOKE-01.md)；NO-MERGE 修复中：把 React 自报改为 native nonce/private trusted-event 严格状态机，补 synthetic/untrusted 恶意负例与 no-read 静态事实 |
