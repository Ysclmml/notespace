...
| `P0-HOST-SMOKE-01` | REVIEW | `/root/p0_host_smoke` / Integration | `4fcc284` / `770ec51` | `EDIT-IME-001`、`FILE-SAVE-001`、`UX-KEY-001`、`UX-PLATFORM-001` / macOS release-host evidence only | [`P0-HOST-SMOKE-01.md`](tasks/P0-HOST-SMOKE-01.md)；24/24 前端、6/6 Rust、full verify、default/feature release runner、审计与 final clean clone PASS；`automatedReady` 不是 `manualPass`，Integration 下一步必须运行真实系统拼音确认/取消、原生菜单激活与 chooser 打开/取消，然后跑当前 schema drift |
